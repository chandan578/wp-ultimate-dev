...
class OurWordFilterPlugin {
  ...
  <?php } else{?>
        <p>Sorry, you do not have a permission to perform that action.</p>
  <?php }
    ...
    <?php if (isset($_POST['justsubmitted']) && $_POST['justsubmitted'] == 'true') $this->handleForm(); ?>
      <form method="POST">
        ...
        <div class="word-filter__flex-container">
          <textarea name="plugin_words_to_filter" id="plugin_words_to_filter" placeholder="bad, mean, awful, horrible"><?php echo esc_attr(get_option('plugin_words_to_filter')) ?></textarea>
        </div>

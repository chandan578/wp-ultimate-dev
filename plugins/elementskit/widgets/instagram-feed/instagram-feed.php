...
class ElementsKit_Widget_Instagram_Feed extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type'               => Controls_Manager::TEXT,
				'frontend_available' => true,
				'default'            => esc_html__($this->ekit_ins_follow, 'elementskit'), //phpcs:ignore WordPress.WP.I18n.NonSingularStringLiteralText
	...
	protected function render_raw() {
		...
		$ins_user_link = strlen($ekit_instagram_feed_ins_follow_link ?? '') > 2 
    		? $ekit_instagram_feed_ins_follow_link 
    		: $this->ekit_ins_follow;
